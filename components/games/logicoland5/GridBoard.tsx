...
export default function GridBoard({
  ...
  return (
    <div className="relative">
      <div className={`grid ${getGridColsClass()} mx-auto gap-2 md:gap-3`}>
              ...
              row.map((cell, colIndex) => {
                ...
                return (
                  <motion.div
                    ...
                    className={` ${cellSize} ${textSize} flex items-center justify-center rounded-xl font-bold transition-all duration-200 cursor-${isInteractive ? "pointer" : "default"} relative shadow-lg ${isSelected ? "ring-4 ring-orange-400 ring-offset-2" : ""} ${isCurrent ? "shadow-xl ring-4 ring-green-500 ring-offset-2" : ""} ${highlighted ? "shadow-xl ring-4 ring-yellow-400 ring-offset-2" : ""} ${visited ? "opacity-90" : ""} `}
                    style={{
                  ...
                  >
                    ...
                    {isColorGrid && (
                      <div
                        className={`absolute inset-0 rounded-xl ${getColorValue(cell as string)}`}
                      />
                    )}
                    ...
                    {isSelected && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="absolute inset-0 rounded-xl border-4 border-orange-400"
                      />
                    )}
                  </motion.div>
                );
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-4">
        {showStart && (
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-r from-gray-400 to-gray-500 font-bold text-white">
              S
            </div>
        ...
        {targetPosition && (
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-r from-yellow-400 to-amber-500 font-bold text-white">
              ⭐
            </div>
        ...
        {isInteractive && (
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 rounded-lg border-4 border-orange-400" />
