...
export default function SecondaryButton({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={disabled}
      className={` ${sizeClasses} ${variantClasses} flex items-center justify-center gap-2 font-bold transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100`}
    >
