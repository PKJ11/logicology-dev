  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div
            className={`${config.bg} border ${config.border} mx-4 max-w-md rounded-2xl p-6 shadow-2xl`}
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="mb-1 text-xl font-bold text-gray-800">{message}</h3>
            ...
            {type === "success" && (
              <motion.div
                ...
                className="mt-4 h-1 rounded-full bg-gradient-to-r from-green-500 to-emerald-500"
              />
            )}
          </div>
        </motion.div>
