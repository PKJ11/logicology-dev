...
import { AlertCircleIcon, CheckCircleIcon, FileIcon, Trash2Icon, XIcon } from "lucide-react";
 ...
 * ```
 */
const FileList = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div ref={ref} className={cn("mt-3 flex w-full flex-col gap-2", className)} {...props}>
