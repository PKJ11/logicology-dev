...
export default function HeroSlider() {
  ...
  useEffect(() => {
    const onPause = () => { isPausedRef.current = true; };
    const onResume = () => { isPausedRef.current = false; };
    window.addEventListener("hero-slider-pause", onPause);
    window.addEventListener("hero-slider-resume", onResume);
    return () => {
      window.removeEventListener("hero-slider-pause", onPause);
      window.removeEventListener("hero-slider-resume", onResume);
    };
  }, []);
