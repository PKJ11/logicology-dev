...
const COUNTRY_FACTS: Record<string, string> = {
  ...
  "Colombia": "Only country in South America with both Pacific and Caribbean coasts!",
  ...
  "Ecuador": "Named after a geographical feature — the Equator!",
  ...
  "Costa Rica": "Has no army — abolished its military in 1948!",
  ...
  "Denmark": "Often ranked the happiest country in the world!",
  "Finland": "Has more saunas than cars — about 3 million saunas!",
  "Switzerland": "Has enough bunkers to shelter its entire population!",
  "Austria": "Birthplace of Mozart, Freud, and Arnold Schwarzenegger!",
  "Belgium": "Invented French fries — not France!",
  "Portugal": "Has the oldest bookshop in the world, open since 1732!",
  "Greece": "Birthplace of democracy, the Olympics, and Western philosophy!",
  "Poland": "Home to the world's largest castle — Malbork Castle!",
  ...
  "Vietnam": "Home to the world's largest cave — Son Doong!",
  "Philippines": "An archipelago of over 7,600 islands!",
  ...
  "Ethiopia": "Only African country never colonized by a European power!",
  "Kenya": "Home to the Great Rift Valley, visible from space!",
  "Tanzania": "Has Africa's highest mountain — Mount Kilimanjaro!",
  "Morocco": "Has the world's oldest university, founded in 859 AD!",
...
export default function GeoKids() {
  ...
  const handleCountryClick = (geoName: string) => {
    ...
    if (normalized === currentCountry) {
      ...
      setStatus("wrong");
      setTimeout(() => { setClickedWrong(null); setStatus("playing"); }, 700);
    }
  };
  ...
  if (screen === "menu") {
    return (
      <div style={{
        ...
        fontFamily: "'Nunito', 'Segoe UI', sans-serif", padding: 20,
      }}>
        <style>{`
        ...
        <div style={{ width: "100%", maxWidth: 500, textAlign: "center" }}>
          <div style={{ fontSize: 100, lineHeight: 1, marginBottom: 16, display: "inline-block", animation: "floatGlobe 4s ease-in-out infinite" }}>🌍</div>

          <h1 style={{ margin: "0 0 10px", fontSize: 60, fontWeight: 900, color: "#1e293b", letterSpacing: -2, lineHeight: 1, animation: "fadeUp 0.5s ease" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 40 }}>
            {[
              { icon: "🎯", label: "10 Rounds", bg: "#eff6ff", border: "#bfdbfe", color: "#2563eb" },
              { icon: "⏱️", label: "20s Each", bg: "#fefce8", border: "#fde68a", color: "#d97706" },
              { icon: "🔥", label: "Streak Bonus", bg: "#fff7ed", border: "#fed7aa", color: "#ea580c" },
              { icon: "✨", label: "Fun Facts", bg: "#f5f3ff", border: "#ddd6fe", color: "#7c3aed" },
          ...
          <button
            ...
            style={{
              ...
              padding: "22px 72px", fontSize: 28, fontWeight: 900,
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 440, textAlign: "center" }}>
          ...
          <div style={{
            ...
            margin: "16px 0 24px", boxShadow: "0 4px 32px #3b82f611",
            ...
            {[
              ...
              <div key={label} style={{
                ...
                <span style={{ flex: 1, textAlign: "left", color: "#64748b", fontSize: 20, fontWeight: 700 }}>{label}</span>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <button onClick={startGame} style={{
              ...
              fontWeight: 900, fontSize: 22, cursor: "pointer", fontFamily: "inherit",
              boxShadow: "0 4px 20px #3b82f644",
            }}>🔄 Play Again</button>
            <button onClick={() => setScreen("menu")} style={{
              flex: 1, padding: "20px 0",
              background: "white", color: "#64748b",
              border: "2.5px solid #e2e8f0", borderRadius: 20,
              fontWeight: 800, fontSize: 22, cursor: "pointer", fontFamily: "inherit",
            }}>🏠 Menu</button>
          </div>
        </div>
      </div>
  ...
  return (
    <div style={{
      ...
      {/* TOP BAR */}
      <div style={{
        background: "white", borderBottom: "2.5px solid #dbeafe",
        padding: "10px 20px", display: "flex", alignItems: "center",
        gap: 10, flexShrink: 0, boxShadow: "0 2px 16px #3b82f61a",
      }}>
        <button onClick={() => setScreen("menu")} style={{
          background: "#eff6ff", border: "none", cursor: "pointer",
          fontSize: 20, padding: "7px 13px", color: "#3b82f6",
        ...
        <div style={{ display: "flex", gap: 5, alignItems: "center" }}>
          {Array.from({ length: ROUNDS }).map((_, i) => (
            <div key={i} style={{
              width: i === roundIdx ? 26 : 10, height: 10, borderRadius: 99,
        ...
        {streak >= 2 && (
          <div style={{
            background: "#fff7ed", color: "#ea580c", fontWeight: 900,
            fontSize: 17, padding: "7px 16px", borderRadius: 99,
      ...
      <div style={{
        ...
        transition: "background 0.3s", minHeight: 90,
        display: "flex", alignItems: "center", justifyContent: "center",
      }}>
        {status === "correct" ? (
          <div>
          ...
          <div>
            <div style={{ fontSize: 26, fontWeight: 900, color: "#dc2626" }}>
              ⏰ Time's up! Answer: <span style={{ textDecoration: "underline" }}>{currentCountry}</span>
            </div>
            {showFact && (
              <div style={{ fontSize: 17, color: "#991b1b", marginTop: 6, fontWeight: 700 }}>✨ {fact}</div>
            )}
          </div>
        ) : (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 28 }}>
            <div>
              <div style={{ color: "#94a3b8", fontSize: 15, fontWeight: 800, textTransform: "uppercase", letterSpacing: 1 }}>
                🔍 Find this country
              </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                fontWeight: 900, fontSize: 20, color: timerColor,
              }}>{timeLeft}</div>
            </div>
          </div>
        )}
      ...
      <div style={{ flex: 1, overflow: "hidden", position: "relative", background: "#dbeafe" }}>
        {hoveredCountry && (
          <div style={{
            ...
            fontSize: 17, fontWeight: 900, zIndex: 10,
            pointerEvents: "none", backdropFilter: "blur(6px)",
            boxShadow: "0 4px 24px #0004", whiteSpace: "nowrap",
          }}>
            📍 {hoveredCountry}
          </div>
        )}
              ...
              geographies.map((geo: GeographyType) => {
                ...
                return (
                  <Geography
                    ...
                    style={{
                      default: {
                        fill, stroke: "white", strokeWidth: 0.6,
                        outline: "none", cursor: status === "playing" ? "pointer" : "default",
      ...
      {/* BOTTOM BAR */}
      <div style={{
        background: "white", borderTop: "2.5px solid #dbeafe",
        ...
        <span style={{ fontSize: 16, fontWeight: 900, color: "#3b82f6" }}>
          GeoKids
        </span>
      </div>
    </div>
