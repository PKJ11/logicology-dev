    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center space-x-2 rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 px-4 py-2 text-white shadow-lg transition-all hover:scale-105"
        >
        ...
        {filteredVideos.map((video) => {
          ...
          return (
            ...
            >
              {/* Thumbnail */}
              <div
                className="group relative h-48 cursor-pointer bg-black"
              ...
              >
                ...
                <div className="absolute left-3 top-3">
                  <span className="rounded-full bg-black bg-opacity-70 px-3 py-1 text-xs text-white">
              ...
              <div className="p-6">
                ...
                <p className="mb-4 line-clamp-2 text-sm text-gray-600">{video.description}</p>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => setPlayingVideo(video._id!)}
                    className="flex-1 rounded-xl bg-purple-500 py-2 text-sm font-medium text-white hover:bg-purple-600"
                  >
                    ▶ Play
                  </button>
                  <Link
