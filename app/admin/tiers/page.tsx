...
export default function TierManagement() {
  ...
  const colorOptions = [
    ...
    },
    {
      ...
      label: "Purple",
      class: "bg-gradient-to-r from-purple-500 to-purple-600",
    },
    {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Manage subscription tiers, pricing, and features</p>
        </div>
        <button
          onClick={handleAdd}
        ...
        {tiers.map((tier) => (
          ...
          >
            ...
            <div className="relative">
              ...
              {/* Description */}
              <p className="mb-4 line-clamp-2 text-sm opacity-90">{tier.description}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
            ...
            >
              ...
              {/* Color */}
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">Tier Color</label>
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 rounded-xl bg-orange-500 px-4 py-2 text-white hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {isSaving ? (
