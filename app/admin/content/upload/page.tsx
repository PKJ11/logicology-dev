      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">
            ...
            {uploadStep === 3 &&
              (contentType === "external_link" ? "Add external link" : "Upload files")}
          </p>
        </div>
        ...
        <div className="col-span-2 space-y-6">
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, wordwallHeader: e.target.value })
                        }
                        className="w-full rounded-xl border border-gray-300 p-3 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-200"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, wordwallIframe: e.target.value })
                        }
                        className="w-full rounded-xl border border-gray-300 p-3 font-mono text-sm focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-200"
                        required={contentType === "wordwall"}
                      />
                      <p className="mt-1 text-xs text-gray-500">
            ...
            contentType !== "mindstamp" && (
              <div className="rounded-2xl bg-white p-6 shadow-xl">
                ...
                {uploadedFiles.length > 0 && (
                  <div className="mt-6">
                    <h3 className="mb-3 font-semibold">Uploaded Files ({uploadedFiles.length})</h3>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-xl">
              ...
              <div className="rounded-lg bg-blue-50 p-4">
                <p className="text-sm text-blue-800">
                  ...
                  {formData.wordwallHeader || "Not set"}
                </p>
                <p className="mt-2 truncate text-sm text-blue-800">
                  <span className="font-semibold">Iframe URL:</span>{" "}
                  {formData.wordwallIframe || "Not set"}
                </p>
              </div>
            </div>
          )}
          ...
          {uploadStep === 3 && contentType === "mindstamp" && (
            <div className="rounded-2xl bg-white p-6 shadow-xl">
              ...
              <div className="space-y-3 rounded-lg bg-purple-50 p-4">
                ...
                {videoPreview && (
                  <div>
                    <p className="mb-2 text-sm font-medium text-purple-800">Preview:</p>
                    <div className="aspect-video w-full overflow-hidden rounded-xl bg-gray-100">
                      <img
                        src={videoPreview}
                        alt="Video thumbnail"
          ...
          <div className="flex justify-between">
            <button
              ...
              className="rounded-xl border border-gray-300 px-6 py-3 transition-colors hover:bg-gray-50"
            ...
            {uploadStep < 3 ? (
              <button
                ...
                className="rounded-xl bg-orange-500 px-6 py-3 text-white transition-colors hover:bg-orange-600 disabled:opacity-50"
              ...
              <button
                ...
                disabled={isSubmitting}
                className="rounded-xl bg-green-500 px-6 py-3 text-white transition-colors hover:bg-green-600 disabled:opacity-50"
              >
                {isSubmitting ? (
          ...
          <div className="sticky top-24 rounded-2xl bg-white p-6 shadow-xl">
            ...
            {formData.title ? (
              <div className="space-y-3">
                ...
                {contentType === "mindstamp" && formData.videoUrl && (
                  <div className="space-y-3">
                    {videoPreview ? (
                      ...
                      <div
                        className="group relative aspect-video w-full cursor-pointer overflow-hidden rounded-xl bg-gray-100"
                      ...
                      <div className="flex aspect-video w-full items-center justify-center rounded-xl bg-purple-50">
                        <div className="text-center">
                ...
                <p className="line-clamp-3 text-sm text-gray-600">{formData.description}</p>
                ...
                {contentType === "external_link" && formData.externalLink && (
                  <div className="mt-2 truncate text-xs text-blue-600">
                    🔗 {formData.externalLink}
                  </div>
                )}

                {contentType === "mindstamp" && formData.videoUrl && (
                  <div className="mt-2 truncate text-xs text-purple-600">
                    🎥 {formData.videoUrl}
                  </div>
                )}
