...
>
  {games.map((game) => (
    <div
      key={game.id}
      // give each card a responsive fixed basis so rows center nicely
    ...
    >
      ...
      >
        ...
        <div className="pt-5">
          {/* 2) Title centered */}
          <h3 className="text-2xl font-bold text-brand-teal text-left">
            {game.title}
          </h3>

          <p className="text-sm text-brand-tealDark/70 text-left">
            by {game.author}
          </p>
