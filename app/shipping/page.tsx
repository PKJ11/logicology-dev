          ...
          <article className="space-y-8">
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              <div className="prose prose-gray mt-3 max-w-none">
                <p>
                  At Logicology, we strive to deliver your orders quickly, safely, and affordably.
                  Please read through our shipping policy to understand how we handle deliveries.
                </p>
              </div>
            </section>
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <p>
                  Currently, Logicology ships orders within India only. We do not offer
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <ul>
                  <li>
                    Orders are usually processed and dispatched within 2 working days of placing the
                    order.
                  </li>
                  <li>
                    The expected delivery time is up to 7 working days (depending on your location
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <ul>
                  ...
                  <li>
                    For orders below ₹999, a flat shipping charge of ₹99 will be applied at
                    checkout.
                  </li>
                </ul>
              </div>
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <ul>
                  <li>
                    Once dispatched, you will receive an email and/or WhatsApp message with your
                    tracking details.
                  </li>
                  <li>
                    You can use this link to follow your order until it reaches your doorstep.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <p>
                  While we aim to deliver within the promised timeframe, unforeseen factors such as
                  courier delays, public holidays, or regional restrictions may cause delays. We
            ...
            <section className="rounded-4xl bg-white p-6 shadow-soft sm:p-8">
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <ul>
                  <li>
                    Please ensure that your shipping address and contact number are entered
                    correctly at checkout.
                  </li>
                  <li>
                    Logicology will not be responsible for orders misplaced due to incorrect or
              ...
              <div className="prose prose-gray mt-3 max-w-none">
                <ul>
                  <li>
                    ...
                    with pictures of the package and product.
                  </li>
                  <li>
                    If your shipment is lost in transit, we will either resend the product or issue
