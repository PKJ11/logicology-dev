  ...
  return (
    <nav
      style={{
        ...
        boxShadow: scrolled ? "0 2px 20px rgba(10,138,128,0.10)" : "0 2px 20px rgba(10,138,128,0.10)",
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        borderRadius: "50%", background: "rgba(216,174,79,0.12)",
        filter: "blur(60px)",
      }} />
      <div style={{
        position: "absolute", bottom: -80, left: -80, width: 400, height: 400,
        borderRadius: "50%", background: "rgba(228,92,72,0.10)",
        filter: "blur(60px)",
      }} />
      {/* Floating dots */}
      {[
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "80px 24px", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <p style={{
          ...
          color: "rgba(255,255,255,0.80)", maxWidth: 640, margin: "0 auto 48px",
          lineHeight: 1.7,
        }}>
...
function SectionTag({ label }: { label: string }) {
  return (
    <div style={{
      ...
      color: "#0A8A80", letterSpacing: "0.10em", textTransform: "uppercase",
    }}>{label}</div>
  );
}
...
function WhyCampsSection() {
  ...
  const benefits = [
    {
      icon: "🧠", title: "They Learn How to Think, Not Just What to Think",
    ...
    {
      icon: "🤝", title: "They Build Social Skills That Screens Can't Teach",
    ...
    {
      icon: "☀️", title: "They Get a Healthy Break from Screens",
    ...
    {
      icon: "⭐", title: "They Return More Confident",
  ...
  return (
    <section id="why-camps" style={{ background: "#F5F6F7", padding: "100px 24px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          <SectionTag label="Why Summer Camps?" />
          <h2 style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800,
            fontSize: "clamp(28px, 4vw, 48px)", color: "#0B3F44", margin: 0,
          }}>
            Why a Summer Camp<br />Changes Everything
          </h2>
          <p style={{
            fontFamily: "'Outfit', sans-serif", fontSize: 18,
            color: "#555", maxWidth: 580, margin: "20px auto 0", lineHeight: 1.7,
          }}>
            Summer breaks are long. Without structure, children often default to screens
            and idle hours. A well-designed summer camp fills that gap — not with busy work,
            but with meaningful experiences that shape how a child thinks, connects, and grows.
          </p>
        </div>
        ...
        <div style={{
          ...
          {benefits.map((b, i) => (
            <BenefitCard key={b.title} benefit={b} delay={i * 120} />
          ))}
        </div>
...
function BenefitCard({ benefit, delay }: { benefit: { icon: string; title: string; desc: string }; delay: number }) {
  const { ref, visible } = useReveal();
  return (
    <div
      ref={ref}
      style={{
        ...
        boxShadow: "0 4px 24px rgba(11,63,68,0.07)",
        opacity: visible ? 1 : 0,
      ...
      onMouseEnter={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 40px rgba(10,138,128,0.15)";
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 4px 24px rgba(11,63,68,0.07)";
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)";
      }}
    >
      <div style={{
        width: 56, height: 56, borderRadius: 16,
        background: "linear-gradient(135deg, rgba(10,138,128,0.12), rgba(216,174,79,0.12))",
        display: "flex", alignItems: "center", justifyContent: "center",
        fontSize: 28, marginBottom: 20,
      }}>{benefit.icon}</div>
      <h3 style={{
        fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
        color: "#0B3F44", margin: "0 0 12px",
      }}>{benefit.title}</h3>
      <p style={{
...
function WhyLogicologySection() {
  ...
  return (
    <section id="why-logicology" style={{
      background: "linear-gradient(160deg, #0B3F44 0%, #0A8A80 100%)",
      padding: "100px 24px", position: "relative", overflow: "hidden",
    }}>
      <div style={{
        position: "absolute", top: -100, right: -100, width: 400, height: 400,
        borderRadius: "50%", background: "rgba(216,174,79,0.08)", filter: "blur(80px)",
      }} />
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        >
          <div style={{
            display: "inline-block",
            background: "rgba(216,174,79,0.15)", border: "1px solid rgba(216,174,79,0.4)",
            borderRadius: 100, padding: "5px 18px", marginBottom: 20,
            fontFamily: "'Outfit', sans-serif", fontSize: 12, fontWeight: 700,
          ...
          <h2 style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800,
            fontSize: "clamp(28px, 4vw, 48px)", color: "#fff", margin: 0,
          }}>
            Not All Camps Are<br />Created Equal.
          </h2>
          <p style={{
            fontFamily: "'Outfit', sans-serif", fontSize: 18,
            color: "rgba(255,255,255,0.75)", maxWidth: 560, margin: "20px auto 0", lineHeight: 1.7,
          }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24 }}>
          {diffs.map((d, i) => (
            <DiffCard key={d.title} diff={d} delay={i * 100} />
          ))}
        </div>

        <div style={{ textAlign: "center", marginTop: 56 }}>
          <a href="#enroll" style={{
            background: "#D8AE4F", color: "#0B3F44",
            padding: "18px 44px", borderRadius: 100,
            fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
            textDecoration: "none", boxShadow: "0 6px 28px rgba(216,174,79,0.45)",
...
function DiffCard({ diff, delay }: { diff: { icon: string; title: string; desc: string }; delay: number }) {
  const { ref, visible } = useReveal();
  return (
    <div
      ref={ref}
    ...
    >
      <div style={{ fontSize: 32, marginBottom: 16 }}>{diff.icon}</div>
      <h3 style={{
        fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
        color: "#D8AE4F", margin: "0 0 10px",
      }}>{diff.title}</h3>
      <p style={{
        fontFamily: "'Outfit', sans-serif", fontSize: 15,
    ...
    <section id="curriculum" style={{ background: "#fff", padding: "100px 24px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 24 }}>
          {modules.map((m, i) => (
            <ModuleCard key={m.title} module={m} delay={i * 100} />
          ))}
        </div>
...
function ModuleCard({ module: m, delay }: { module: { icon: string; tag: string; title: string; desc: string; color: string }; delay: number }) {
  const { ref, visible } = useReveal();
  return (
    <div
      ref={ref}
      style={{
        background: "#F5F6F7", borderRadius: 20, padding: 32,
        opacity: visible ? 1 : 0,
        transform: visible ? "translateY(0)" : "translateY(40px)",
        transition: `all 0.7s ease ${delay}ms`,
    ...
    >
      <div style={{
        ...
        background: m.color, borderRadius: "20px 20px 0 0",
      }} />
      <div style={{ fontSize: 36, marginBottom: 12 }}>{m.icon}</div>
      <div style={{
        display: "inline-block", background: m.color + "22",
        borderRadius: 100, padding: "3px 14px", marginBottom: 12,
        fontFamily: "'Outfit', sans-serif", fontSize: 11, fontWeight: 700,
        color: m.color, letterSpacing: "0.08em", textTransform: "uppercase",
      }}>{m.tag}</div>
      <h3 style={{
        fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
        color: "#0B3F44", margin: "0 0 10px",
      }}>{m.title}</h3>
      <p style={{
        fontFamily: "'Outfit', sans-serif", fontSize: 15,
        color: "#666", lineHeight: 1.7, margin: 0,
...
function HowToEnrollSection() {
  ...
  return (
    <section id="how-to-enroll" style={{ background: "#F5F6F7", padding: "100px 24px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          <SectionTag label="Enrollment" />
          <h2 style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800,
            fontSize: "clamp(28px, 4vw, 48px)", color: "#0B3F44", margin: "0 0 12px",
          }}>Getting Started Is Simple</h2>
          <p style={{
            fontFamily: "'Outfit', sans-serif", fontSize: 18, color: "#666",
          }}>Three steps. Five minutes. One decision that could shape your child's summer.</p>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          {steps.map((s, i) => (
            <StepCard key={s.title} step={s} delay={i * 150} />
          ))}
        </div>
...
function StepCard({ step: s, delay }: { step: { num: string; icon: string; title: string; desc: string }; delay: number }) {
  const { ref, visible } = useReveal();
  return (
    <div
      ref={ref}
      style={{
        ...
        boxShadow: "0 4px 20px rgba(11,63,68,0.06)",
        border: "1px solid rgba(10,138,128,0.10)",
        opacity: visible ? 1 : 0,
        transform: visible ? "translateX(0)" : "translateX(-32px)",
        transition: `all 0.7s ease ${delay}ms`,
      }}
      onMouseEnter={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 36px rgba(10,138,128,0.14)";
        (e.currentTarget as HTMLDivElement).style.transform = "translateX(6px)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 4px 20px rgba(11,63,68,0.06)";
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
          ...
          <h3 style={{
            ...
            color: "#0B3F44", margin: 0,
          }}>{s.title}</h3>
        </div>
        <p style={{
          fontFamily: "'Outfit', sans-serif", fontSize: 15, color: "#666",
...
function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" style={{ background: "#fff", padding: "100px 24px", overflow: "hidden" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div
          ref={ref}
          style={{
...
function TestimonialCard({ t, delay }: { t: { quote: string; name: string; child: string }; delay: number }) {
  const { ref, visible } = useReveal();
  return (
    <div
      ref={ref}
      ...
      onMouseEnter={e => {
        (e.currentTarget as HTMLDivElement).style.background = "linear-gradient(135deg, rgba(10,138,128,0.06), rgba(216,174,79,0.06))";
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)";
        (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 36px rgba(10,138,128,0.12)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.background = "#F5F6F7";
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)";
        (e.currentTarget as HTMLDivElement).style.boxShadow = "none";
      }}
    >
      <div style={{
        fontFamily: "'Outfit', sans-serif", fontSize: 48, color: "#0A8A80",
        lineHeight: 1, marginBottom: 12, opacity: 0.4,
      }}>"</div>
      <p style={{
        fontFamily: "'Outfit', sans-serif", fontSize: 16,
        color: "#444", lineHeight: 1.7, margin: "0 0 24px", fontStyle: "italic",
      }}>{t.quote}</p>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div>
          <div style={{
            ...
            fontSize: 15, color: "#0B3F44",
          }}>{t.name}</div>
          <div style={{
            fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "#888",
          }}>{t.child}</div>
        </div>
      </div>
    </div>
...
function FAQSection() {
  ...
  const faqs = [
    ...
    { q: "Where is the camp located?", a: "Humpyard Road, Dhantoli, Near Dinanath High School. The venue is fully air-conditioned, CCTV-monitored, and equipped with dedicated learning and activity spaces. Directions will be shared in your confirmation message. Please note there isnt ample 4 wheeler parking available near the center, you may have to park on the Humpyard road." },
    { q: "What are the camp dates and timings?", a: "We run multiple batches throughout the summer. Each batch runs for 5 or 10 days, the timings are 10 am to 1 pm. You can choose your preferred batch during enrollment. Specific dates for the camps are listed on the website. Senior camps are 60/90 minutes and junior camps are for 180 minutes" },
    { q: "How much does it cost?", a: "The camp fee ranges from INR 1000-INR 6000 per child based on the programme. This includes GST and accompanying worksheets, material and access to one month of Logicology.online subscription for the related content. Sibling discount of 10% is available to both siblings (for fees more than INR3000). Group discounts are available for groups of 5 or more enrolling together. Please contact us for details." },
    { q: "What is the refund and cancellation policy?", a: "Full refunds are available if the batch gets cancelled due to some reasons. Cancellation after the first day of the workshop is possible with 80% refund. No refunds are issued after child attends 2nd day of the camp. If you enrol for a camp and need to travel or have some unforeseen issues before the batch begins, we will make a full refund (after deducting INR 200 as registration charges)" },
    { q: "What safety measures are in place?", a: "Safety is our top priority. Our measures include: secured premises with controlled entry and exit, CCTV monitoring across all common areas, verified background checks for all instructors and support staff. We request you to not drop the children on the ground floor when our team members are not present. Our team members may ask for identity card of the person coming to pick up the child." },
    { q: "Does my child need any specific skills or capabilities?", a: "Your child should be able to read, write and communicate in English, Hindi or Marathi. We DO NOT possess the capabilities to manage children with special needs during our camps. If your child has any specific special needs, we request you to contact us and let us know the nature of special needs before enrolling. In the absence of such intimation, we assume that the child does not have any special needs." },
    { q: "What should my child bring to camp?", a: "Children should bring a water bottle, a light snack (if they have specific dietary needs), and comfortable clothing. We DO NOT provide any food items. We request you to not send any food items that stink or can be easily spilt. All learning materials, worksheets, books (wherever applicable) are provided by Logicology. Erasers and sharpeners will be provided only for use during the summer camp, if your child wants to bring their own they are allowed to bring their own writing materials." },
    ...
    { q: "How do I contact you if I have more questions?", a: "You can reach us on WhatsApp us at 8446980747. Our team typically responds within a few hours during business hours. If you need to talk to one of our instructors, send us a whatsapp specifying the nature of the query and we will call you back." },
    ...
    { q: "The age range is 6-9 how do you ensure that the children get age appropriate material?", a: "Our content is based on Logic and to a very large extent does not tie to any specific class in school. In rare cases where some children may not be aware of a specific concept (for example if one 6 year old child does not know what are vowels and consonants), our instructor will teach that concept to the child and move on. We try to make sure that students from one age group are segregated in one batch as far as possible - however, given the timing constraints, choices of parents and demand for each workshop it is not always possible to make that happen." },
  ];
  return (
    <section id="faqs" style={{ background: "#F5F6F7", padding: "100px 24px" }}>
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        >
          ...
          <h2 style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800,
            fontSize: "clamp(28px, 4vw, 44px)", color: "#0B3F44", margin: 0,
          ...
          {faqs.map((f, i) => (
            ...
            >
              ...
              >
                ...
                <span style={{
                  fontSize: 20, color: "#0A8A80", flexShrink: 0, marginLeft: 16,
...
function EnrollButton() {
  return (
    <a href="#enroll" style={{
      ...
      color: "#fff", padding: "18px 44px", borderRadius: 100,
      fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
      textDecoration: "none", boxShadow: "0 6px 32px rgba(228,92,72,0.35)",
...
function EnrollmentSection() {
  ...
  const validate = () => {
    ...
    if (!form.consent) e.consent = "Please accept the Terms & Conditions to proceed." as any;
  ...
  const sendWhatsApp = async (paymentId: string) => {
    ...
    try {
      await fetch("https://api.interakt.ai/v1/public/track/users/", {
        ...
        body: JSON.stringify({
          phoneNumber: cleanedPhone, countryCode: "+91",
          traits: { name: form.parentName, email: form.email, lastPaymentId: paymentId, campBatch: form.preferredBatch },
        }),
      });
      ...
      await fetch("https://api.interakt.ai/v1/public/message/", {
        ...
        body: JSON.stringify({
          countryCode: "+91", phoneNumber: cleanedPhone,
          type: "Template",
          template: {
            name: "purchase",
            languageCode: "en",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const options = {
        ...
        name: "Logicology",
        description: `Summer Camp Enrollment — ${form.preferredBatch}`,
        order_id: order.id,
          ...
          try {
            ...
            await fetch("/api/save-order-info", {
              ...
              body: JSON.stringify({
                ...
                shipping: {
                  name: form.childName, address: "Summer Camp", building: "", street: "",
                  landmark: "", pin: "", city: "", state: "", phone: form.phone, email: form.email,
                  isGift: false, isDifferentFromBiller: false,
                },
                cart: [{
                  name: `Logicology Summer Camp — ${form.preferredBatch}`,
                  price: `₹${CAMP_FEE}`, quantity: 1, razorpayItemId: "summer-camp",
                }],
                paymentId: response.razorpay_payment_id,
                orderId: response.razorpay_order_id,
                razorpayDesc: `Summer Camp — ${form.childName}, Batch: ${form.preferredBatch}`,
                totalAmount: CAMP_FEE,
                discountAmount: 0,
                appliedPromo: null,
                isGift: false,
  ...
  const labelStyle: React.CSSProperties = {
    ...
    color: "#0B3F44", marginBottom: 6,
  };

  const errStyle: React.CSSProperties = {
    fontFamily: "'Outfit', sans-serif", fontSize: 12, color: "#E45C48", marginTop: 4,
  };
    ...
    <section id="enroll" style={{
      ...
      {isPaymentProcessing && (
        <div style={{
          ...
          background: "rgba(11,63,68,0.85)", backdropFilter: "blur(12px)",
          display: "flex", alignItems: "center", justifyContent: "center",
        }}>
          <div style={{
            ...
            <div style={{
              ...
              border: "4px solid #0A8A80", borderTopColor: "transparent",
              margin: "0 auto 24px",
              animation: "spin 1s linear infinite",
            }} />
            <h3 style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 22, color: "#0B3F44", margin: "0 0 10px" }}>
              Processing Enrollment
            </h3>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 15, color: "#666", margin: "0 0 20px" }}>
              Confirming your payment and sending enrollment details...
            </p>
            <div style={{
              background: "#FFF9E6", border: "1px solid #D8AE4F",
              borderRadius: 12, padding: "12px 16px",
              fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "#8B6914", fontWeight: 600,
            }}>⚠️ Do not close or refresh this page</div>
          </div>
        </div>
      )}
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <h2 style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800,
            fontSize: "clamp(28px, 4vw, 48px)", color: "#fff", margin: "0 0 12px",
          }}>Enroll Your Child Today</h2>
          <p style={{
            fontFamily: "'Outfit', sans-serif", fontSize: 17,
            color: "rgba(255,255,255,0.75)", margin: 0,
          }}>Fill in the details below and secure your child's spot at Logicology Summer Camp.</p>
        </div>

        {/* Fee card */}
        <div style={{
          background: "rgba(216,174,79,0.15)", border: "2px solid rgba(216,174,79,0.35)",
          ...
          <div style={{
            ...
            fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "#fff", fontWeight: 600,
          }}>🏷️ Sibling discounts available</div>
        </div>
        ...
        <div style={{ background: "#fff", borderRadius: 24, padding: "40px 40px", boxShadow: "0 24px 80px rgba(0,0,0,0.20)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <input
                type="text" value={form.parentName}
                onChange={e => setForm(f => ({ ...f, parentName: e.target.value }))}
                placeholder="Your full name"
                style={inputStyle(!!errors.parentName)}
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.parentName ? "#E45C48" : "rgba(10,138,128,0.2)")}
              />
            ...
            <div>
              ...
              <input
                ...
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.email ? "#E45C48" : "rgba(10,138,128,0.2)")}
              />
            ...
            <div>
              ...
              <input
                ...
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.phone ? "#E45C48" : "rgba(10,138,128,0.2)")}
              />
            ...
            <div>
              ...
              <input
                ...
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.childName ? "#E45C48" : "rgba(10,138,128,0.2)")}
              />
            ...
            <div>
              ...
              <select
                ...
                style={inputStyle(!!errors.childAge)}
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.childAge ? "#E45C48" : "rgba(10,138,128,0.2)")}
              >
            ...
            {/* Grade */}
            <div>
              <label style={labelStyle}>Child's Grade / Class *</label>
              <select
                value={form.childGrade}
                onChange={e => setForm(f => ({ ...f, childGrade: e.target.value }))}
                style={inputStyle(!!errors.childGrade)}
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.childGrade ? "#E45C48" : "rgba(10,138,128,0.2)")}
              >
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              <select
                ...
                style={inputStyle(!!errors.preferredBatch)}
                onFocus={e => (e.target.style.borderColor = "#0A8A80")}
                onBlur={e => (e.target.style.borderColor = errors.preferredBatch ? "#E45C48" : "rgba(10,138,128,0.2)")}
              >
            ...
            {/* Allergies */}
            <div style={{ gridColumn: "1 / -1" }}>
              <label style={labelStyle}>Allergies or Medical Conditions</label>
              <textarea
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              {errors.consent && <div style={errStyle}>error</div>}
            </div>
          </div>
          ...
          <button
            ...
            style={{
              ...
              color: "#fff", padding: "18px", borderRadius: 100, border: "none",
              fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18,
...
function Footer() {
  return (
    <footer style={{
      background: "#0B3F44", padding: "60px 24px 32px",
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 18, color: "#fff" }}>Logicology</span>
            </div>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.55)", lineHeight: 1.7 }}>
              Empowering children to think clearly, creatively, and independently.
            </p>
          </div>
          <div>
            ...
            {[
              { label: "📧", val: "logicologymeta@gmail.com" },
              { label: "📱", val: "8446980747" },
            ].map(c => (
              <div key={c.val} style={{ fontFamily: "'Outfit', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.65)", marginBottom: 8 }}>
                {c.label} {c.val}
              </div>
            ))}
          </div>
          <div>
            ...
            {["About Logicology", "Terms & Conditions", "Privacy Policy", "Refund Policy"].map(l => (
              <div key={l} style={{ marginBottom: 8 }}>
                <a href="#" style={{ fontFamily: "'Outfit', sans-serif", fontSize: 14, color: "rgba(255,255,255,0.65)", textDecoration: "none" }}
                  onMouseEnter={e => (e.currentTarget.style.color = "#D8AE4F")}
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              {["Instagram", "Facebook", "YouTube"].map(s => (
                <a key={s} href="#" style={{
                  fontFamily: "'Outfit', sans-serif", fontSize: 13, fontWeight: 600,
                  color: "#0B3F44", background: "#D8AE4F",
        ...
        <div style={{
          borderTop: "1px solid rgba(255,255,255,0.10)", paddingTop: 24, textAlign: "center",
          fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.4)",
        }}>
