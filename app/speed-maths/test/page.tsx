...
function PaletteContent({
  ...
  return (
    <>
      <div
        style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 4, marginBottom: 10 }}
      >
        {questions.map((q, i) => (
          <button
            key={q.id}
            onClick={() => onJump(i)}
            title={`Q${q.id} — Set ${q.setLabel}`}
            style={{
              width: 28,
              height: 28,
              border: "none",
              borderRadius: 5,
              background: getBg(q.id),
              color: "#fff",
              fontFamily: RACING,
              fontSize: "0.65rem",
              cursor: "pointer",
...
function TestPage({ onSubmit }: { onSubmit: (r: SubmitPayload) => void }) {
  ...
  const stageLabel =
    q.stage === 1
      ...
      : "Section B — Multiply / Divide / Fractions";
  const isMarked = !!markedReview[q.id];
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: `linear-gradient(135deg,${BRAND_TEAL_DK} 0%,${BRAND_TEAL} 100%)`,
          color: "#fff",
        }}
      >
        <div
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ fontSize: "1.6rem", animation: "rocketBob 3s ease-in-out infinite" }}>
              🚀
            </div>
            <div>
              <div style={{ fontFamily: RACING, fontSize: "1rem", letterSpacing: "0.5px" }}>
                Logicology Test
              </div>
              <div style={{ fontSize: "0.6rem", color: "rgba(255,255,255,0.7)" }}>
                Computer Based Test &nbsp;|&nbsp; Numerical Value Questions
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: "0.65rem", color: "#555" }}>
              ...
              &nbsp;|&nbsp; Negative:{" "}
              <span style={{ color: "#dc2626", fontWeight: 700 }}>{marking.incorrect}</span>
            </div>
            {isMarked && (
              <div
                style={{
          ...
          <div
            style={{
              ...
              border: `2px solid ${BRAND_TEAL}33`,
              borderRadius: 12,
              color: BRAND_TEAL_DK,
              minHeight: 90,
              display: "flex",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <div style={{ fontSize: "0.7rem", color: BRAND_TEAL_DK, fontWeight: 700 }}>
...
function ResultsPage({
  ...
  const penalty = detailed.reduce(
    (s, d) => s + (d.attempted && !d.correct ? Math.abs(d.points) : 0),
    0
  );
    ...
    score >= 25
      ...
      : score >= 15
        ...
        : score >= 5
          ...
          : "Keep Practicing!";
  const gradeColor =
    score >= 25 ? "#059669" : score >= 15 ? BRAND_TEAL : score >= 5 ? "#d97706" : "#dc2626";
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: `linear-gradient(135deg,${BRAND_TEAL_DK},${BRAND_TEAL})`,
          color: "#fff",
          padding: "10px 14px",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontFamily: RACING, fontSize: "1rem" }}>
              Logicology Test — Result Sheet
            </div>
            <div style={{ fontSize: "0.6rem", color: "rgba(255,255,255,0.7)" }}>
      ...
      {saveStatus !== "idle" && (
        <div
          style={{
            ...
            right: 20,
            background:
              saveStatus === "saved" ? "#059669" : saveStatus === "error" ? "#dc2626" : "#F5A623",
            color: "#fff",
            padding: "8px 16px",
            borderRadius: 8,
            fontSize: "0.8rem",
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ color: BRAND_TEAL_DK, margin: 0, fontSize: "0.9rem" }}>
              Final Score:{" "}
              <span style={{ fontFamily: RACING, fontSize: "1.8rem", color: gradeColor }}>
                {score > 0 ? `+${score}` : score}
              </span>
            </p>
            {timeUp && (
          ...
          <div
            style={{ fontSize: "0.75rem", color: "#64748b", textAlign: "right", lineHeight: 1.8 }}
          >
            <div>
              Max possible: <strong style={{ color: "#059669" }}>+30</strong>
            </div>
            <div>
              Min possible: <strong style={{ color: "#dc2626" }}>−20</strong>
            </div>
            <div>
              Time: <strong>{formatTime(timeUsed)} / 5:00</strong>
            </div>
          </div>
        </div>
        ...
        >
          {[
            ...
            {
              label: "STAGE 1 PTS",
              val: stage1Points > 0 ? `+${stage1Points}` : stage1Points,
              color: "#26a9e0",
            },
            {
              label: "STAGE 2 PTS",
              val: stage2Points > 0 ? `+${stage2Points}` : stage2Points,
              color: "#F5A623",
            },
            ...
            <div
              ...
              style={{
                background: "#fff",
                border: `1px solid ${BRAND_TEAL}22`,
                borderRadius: 10,
                padding: "10px 8px",
                textAlign: "center",
              }}
        ...
        <div
          style={{
            background: "#fff",
            border: `2px solid ${BRAND_TEAL}22`,
            borderRadius: 16,
            overflow: "hidden",
            marginBottom: 16,
          }}
        >
          <div
            style={{
              ...
              color: "#fff",
              display: "grid",
              gridTemplateColumns: "48px 36px 1fr 90px 90px 48px",
              padding: "8px 14px",
              fontFamily: RACING,
              fontSize: "0.65rem",
            }}
          ...
          {detailed.map((item, idx) => (
            ...
            >
              <div style={{ fontFamily: RACING, fontSize: "0.75rem", color: BRAND_TEAL_DK }}>
                {item.id}
              </div>
              <div>
                <span
                  style={{
                    background: SET_COLORS[item.setLabel],
                    color: "#fff",
                    fontFamily: RACING,
                    fontSize: "0.6rem",
                    padding: "1px 6px",
              ...
              >
                {item.attempted
                  ? isNaN(Number(item.userAnswer))
                    ? item.userAnswer
                    : Number(item.userAnswer).toFixed(2)
                  : "—"}
              </div>
              <div style={{ textAlign: "center", color: "#555", fontSize: "0.8rem" }}>
                {Number(item.answer).toFixed(2)}
              </div>
              <div
                style={{
                  textAlign: "center",
        ...
        >
          <span style={{ fontFamily: RACING }}>Scoring Formula:</span> Stage 1: +1/−1 &nbsp;•&nbsp;
          Stage 2: +2/−2
          <br />
          Score = (Correct₁ × 1) + (Correct₂ × 2) − (Wrong₁ × 1) − (Wrong₂ × 2)
          <br />
    ...
    >
      ...
      >
        ...
        {[
          {
            num: "1",
            text: "20 questions total. Each question appears one at a time. Navigate freely using PREV / NEXT or the Question Palette.",
          },
          {
            num: "⏱",
            text: "You have 5 minutes. When time expires the test auto-submits.",
            numBg: "#dc2626",
          },
          { num: "2", isScoring: true },
          {
            num: "3",
            text: "Each question slot is independently drawn from one of four question Sets (A, B, C, D), so every user sees a unique mix.",
          },
          {
            num: "4",
            text: "Use the Question Palette to navigate. Mark questions purple to revisit them.",
          },
          {
            num: "5",
            text: "Correct answers are revealed only after the test ends. No live feedback during the test.",
          },
        ].map((item, i) => (
          <div key={i} style={{ display: "flex", gap: 14, marginBottom: 18 }}>
            <div
              style={{
                ...
                height: 30,
                borderRadius: "50%",
                background: (item as any).numBg || BRAND_TEAL,
                color: "#fff",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                  ...
                  >
                    ...
                    <p style={{ margin: 0, fontSize: "0.8rem" }}>
                      ✓ Correct: <strong>+1</strong> &nbsp;|&nbsp; ✗ Wrong: <strong>−1</strong>
                    </p>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <p style={{ margin: 0, fontSize: "0.8rem" }}>
                      ✓ Correct: <strong>+2</strong> &nbsp;|&nbsp; ✗ Wrong: <strong>−2</strong>
                    </p>
                  </div>
                </div>
              </div>
            ) : (
              <p style={{ margin: 0, color: BRAND_TEAL_DK, fontSize: "0.9rem", lineHeight: 1.5 }}>
                {(item as any).text}
              </p>
            )}
          </div>
      ...
      <button
        ...
        style={{
          ...
          padding: "16px",
          cursor: "pointer",
          boxShadow: `0 8px 32px ${BRAND_TEAL}55`,
          animation: "pulse 2s ease-in-out infinite",
        }}
      >
        🚀 Start Test!
...
export default function SpeedMathsTestPage() {
  const [page, setPage] = useState<"splash" | "username" | "instructions" | "test" | "results">(
    "splash"
  );
  const [result, setResult] = useState<SubmitPayload | null>(null);
  const [username, setUsername] = useState<string>("");

  if (page === "splash") return <Splash onDone={() => setPage("username")} />;
  if (page === "username")
    return (
      <UsernamePage
        onSubmit={(name) => {
  ...
  if (page === "results" && result)
    return (
      <ResultsPage
        result={result}
        username={username}
        onRetry={() => setPage("test")}
        onMenu={() => setPage("instructions")}
      />
    );
  return null;
}
