...
function generateConfirmationEmail(
  ...
  const gstReceiptHtml = generateCampGSTReceipt(
    batch,
    baseAmount,
    paymentId,
    parentName,
      ...
      const options = {
        ...
        handler: async function (response: any) {
          ...
          try {
            ...
            router.push(`/summercamp2026/myCourseDeatil?id=${registrationId}`);
          } catch (err) {
            console.error("Post-payment error:", err);
            alert(
              "Payment was successful but there was an issue saving your enrollment. " +
      ...
      {isPaymentProcessing && (
        ...
        >
          ...
          >
            ...
            >
              Confirming your payment and sending GST invoice...
            </p>
            <div
              style={{
                background: "#FFF9E6",
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        {showPricingTable && (
          ...
          >
            ...
            >
              ...
              >
                All prices are base fees. 18% GST will be added at checkout.
              </p>
              <table
                style={{
                  width: "100%",
              ...
              >
                    ...
                    {["Programme", "Dates", "Timings", "Base Fee", "Total (incl. GST)"].map((h) => (
                      <th
                        ...
                        style={{
                          ...
                          textTransform: "uppercase",
                          letterSpacing: "0.07em",
                          textAlign: h.includes("Fee") || h.includes("Total") ? "right" : "left",
                          whiteSpace: "nowrap",
                ...
                <tbody>
                  <tr>
                    <td
                      colSpan={5}
                      style={{ ...categoryRowStyle, background: "rgba(10,138,128,0.25)" }}
                    >
                  ...
                  {juniorRows.map((row, i) => (
                    ...
                    >
                      ...
                      >
                        ₹{calcGST(row.fee).total.toLocaleString("en-IN")}
                      </td>
                    </tr>
                  ))}
                  <tr>
                    <td
                      colSpan={5}
                      style={{ ...categoryRowStyle, background: "rgba(216,174,79,0.15)" }}
                    >
        ...
        >
          ...
          >
            {isProcessing
              ? "Processing..."
              : `Enroll Now — Pay ₹${activeFee.toLocaleString("en-IN")} (incl. 18% GST) →`}
          </button>
          ...
          >
            🔒 Secure payment via Razorpay · 256-bit SSL encrypted · GST invoice emailed
            automatically
          </div>
        </div>
      </div>
